...
Leave it running. You can see Temporal Web at [localhost:8080](localhost:8080) for the WebUi in Beta, or the legacy WebUi at [localhost:8088](localhost:8088). There should be no workflows visible in the dashboard right now.
